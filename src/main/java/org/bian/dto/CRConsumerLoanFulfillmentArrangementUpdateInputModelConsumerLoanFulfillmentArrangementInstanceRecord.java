...
import org.bian.dto.CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecordAssociations;

import javax.validation.Valid;
  
/**
 * CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecord
 */
public class CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecord   {
  ...
  private CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecordAssociations associations = null;
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FYsVBcTGEeChad0JzLk7QA_-1076024413  bian-reference: loanAgreement.CustomerAgreement  general-info: Reference to the associated customer agreement 
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FQCvV8TGEeChad0JzLk7QA_1351565206  bian-reference: loanAgreement.CustomerAgreement.CustomerRelationship.CustomerRating  general-info: Reference to an associated credit assessment 
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FNqJt8TGEeChad0JzLk7QA_-1317971633/elements/_z2I6YGx5EeKmZJ0Ago--9g_239738909  bian-reference: LoanAccount (as Account).AccountInvolvementAsPartyRole.Party.Location  general-info: Bank branch associated with the account for booking purposes 
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FLlGEcTGEeChad0JzLk7QA_1826831344  bian-reference: LoanAgreement.CollateralAgreement  general-info: Reference to allocated collateral 
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FLlGEcTGEeChad0JzLk7QA_1826831345  bian-reference: LoanAgreement.CollateralAgreement.CollateralArrangement.CollateralAsset.AssetValuation  general-info: The collateral value applied to the loan 
  ...
  **/
  ...
  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FEHzNMTGEeChad0JzLk7QA_-1382123937/elements/_FEHzNcTGEeChad0JzLk7QA_-1792766550  bian-reference: PartyIdentification (as TaxIdentificationNumber)  general-info: Reference identifier linking the account to appropriate tax handling 
   * @return taxReference
  **/
  ...
  **/
  ...
  public CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecordAssociations getAssociations() {
    return associations;
  }

  public void setAssociations(CRConsumerLoanFulfillmentArrangementUpdateInputModelConsumerLoanFulfillmentArrangementInstanceRecordAssociations associations) {
    this.associations = associations;
  }


  /**
   * `status: Registered`  iso-link: https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_mw1ysHJTEeWwf47VrwMaTQ/elements/_cuCbkXJUEeWwf47VrwMaTQ  bian-reference: LoanArrangement(as RepaymentArrangement).RepaymentModality  general-info: The schedule for loan repayments 
