...
public class ConsumerLoanApiController {
	...
	@Fulfill.Activate
	public BianResponse<SDConsumerLoanActivateOutputModel> activate(@RequestBody BianRequest<SDConsumerLoanActivateInputModel> bianRequest) {
		return BianResponse.forSuccess(service.activate(bianRequest.getData()));
	}
	
	@Fulfill.Configure
	public BianResponse<SDConsumerLoanConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDConsumerLoanConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Control
	public BianResponse<CRConsumerLoanFulfillmentArrangementControlOutputModel> control(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRConsumerLoanFulfillmentArrangementControlInputModel> bianRequest) {
	...
	@Fulfill.Feedback
	public BianResponse<SDConsumerLoanFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDConsumerLoanFeedbackInputModel> bianRequest) {
		return BianResponse.forSuccess(service.feedback(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Initiate
	public BianResponse<CRConsumerLoanFulfillmentArrangementInitiateOutputModel> initiate(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRConsumerLoanFulfillmentArrangementInitiateInputModel> bianRequest) {
	...
	@Fulfill.Retrieve
	public BianResponse<CRConsumerLoanFulfillmentArrangementRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@Fulfill.RetrieveSD
	public BianResponse<SDConsumerLoanRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
		return BianResponse.forSuccess(service.retrieveSD(sdReferenceId));
	}
	
	@Fulfill.Update
	public BianResponse<CRConsumerLoanFulfillmentArrangementUpdateOutputModel> update(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRConsumerLoanFulfillmentArrangementUpdateInputModel> bianRequest) {
